...
\subfigure[5x5 Percent Improvement]{
  ...
  \caption{NEAT: Average fitness plotted over generations for a 5x5 grid for
  monolithic network and network seeded with modular networks evolved for 50
  generations}
  \label{fig:MeanMAPNDCGPI1} % label for entire figure
\end{figure*}
...
\subfigure[5x5 Percent Improvement]{
  ...
  \label{fig:MeanMAPNDCGPI2} % label for entire figure
\end{figure*}
...
\subfigure[10x10 Percent Improvement]{
  ...
  \caption{NEAT: Average fitness plotted over generations for a 10x10 grid for
  monolithic network and network seeded with modular networks evolved for 50
  generations}
  \label{fig:MeanMAPNDCGPI3} % label for entire figure
\end{figure*}
...
\subfigure[10x10 Percent Improvement]{
  ...
  monolithic network and network seeded with modular networks evolved for 5,
  10, 15 and 50 generations}
  \label{fig:MeanMAPNDCGPI4} % label for entire figure
\end{figure*}
...
\subfigure[5x5 Percent Improvement]{
  ...
  \caption{NEAT: Champion fitness plotted over generations for a 5x5 grid for
  monolithic network and network seeded with modular networks evolved for 50
  generations}
  \label{fig:MeanMAPNDCGPI5} % label for entire figure
\end{figure*}
...
\subfigure[5x5 Percent Improvement]{
  ...
  monolithic network and network seeded with modular networks evolved for 5,
  10, 15 and 50 generations}
  \label{fig:MeanMAPNDCGPI6} % label for entire figure
\end{figure*}
...
\subfigure[10x10 Percent Improvement]{
  ...
  \caption{NEAT: Champion fitness plotted over generations for a 10x10 grid for
  monolithic network and network seeded with modular networks evolved for 50
  generations}
  \label{fig:MeanMAPNDCGPI7} % label for entire figure
\end{figure*}
...
\subfigure[10x10 Percent Improvement]{
  ...
  monolithic network and network seeded with modular networks evolved for 5,
  10, 15 and 50 generations}
  \label{fig:MeanMAPNDCGPI8} % label for entire figure
\end{figure*}
