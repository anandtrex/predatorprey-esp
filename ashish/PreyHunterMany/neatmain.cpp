...
int main(int argc, char *argv[]) {
  ...
  if (argc < 8) {
    ...
    cerr << "6. path of starter genome file is expected" << endl; // ARG 5
    cerr << "7. name for plotting is expected" << endl; // ARG 6
    return -1;
  }
  ...
  string pathStarterGenomeFile( argv[6] );
  string namePlotFile( argv[7] );
  cout << "Beginnning predatorpreyhunter_test";
  p = predatorpreyhunter_test( gens, pathStarterGenomeFile, namePlotFile, mapWidth, mapHeight, noHunters );
