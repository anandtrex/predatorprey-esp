 ...
 * Subtask 1 : Only predators and Prey. No hunters
 */
class PredPreyST1: public Environment
{
public:
    PredPreyST1(int num_of_predators, int num_of_prey, int num_teams_predator, int num_teams_prey,
            vector<double> prey_move_probability);
    PredPreyST1(int num_of_predators, int num_teams_predator);
